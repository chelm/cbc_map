...
(function next () {
  ...
  csv.parse(fs.readFileSync('../2015/data/'+regions[len]+'.csv').toString(), function(err, data){
    stats[ regions[ len ] ] = {};
