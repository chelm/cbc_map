function App( path ){
  ...
  function init(){
    ...
    d3.csv( path, function(d) {
      ...
      if (_app.counties.indexOf(county) == -1 && d.region == 'Mountain') { 
...
//          })
  ...
  _app.buildCountyText = function( year ){
    ...
    var n = (name == 'all') ? "the <span class='stat'>Mountain</span> region" : "<span class='stat'>" + name.replace(/\w\S*/g,   function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}) + '</span> County';
